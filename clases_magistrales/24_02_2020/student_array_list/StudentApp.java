...
/*
Este codigo fue refactorizado (mejorado) usando ArrayList por el estudiante Daniel Otero.
 */
public class StudentApp {
    static final int numStudents = 5;
    // static Student estudiantes[] = new Student[numStudents];
    
    static ArrayList<Student> estudiantesArray = new ArrayList<>();
                        ...
                        switch(profesorOpc) {
                            ...
                            case 3:
                                ...
                                for(int i = 0; i < numStudents; i++) {
                                    if (estudiantesArray.get(i).getId().equals(id)) {
                                        estSeleccionado = i;
                                        break;
                                    }
                                ...
                                estudiantesArray.get(estSeleccionado).setGrade(numNota - 1 , nota);
                                break;
                            case 4:
    ...
    public static void cargarDatos() {
        ...
        for(int i = 0; i < numStudents; i++) {
            ...
            estudiantesArray.add(i,new Student(names[i],ids[i],notas[i]));
        }       
    }
    ...
    public static void imprimirLista () {
        ...
        for(int i = 0; i < numStudents; i++) {
            System.out.println(i + ". " + estudiantesArray.get(i).getId() + "   " + estudiantesArray.get(i).getName());
        }
    }
    ...
    public static Student obtenerDatosEstudiante(String id) {
        ...
        for(int i = 0; i < numStudents; i++) {
            if (estudiantesArray.get(i).getId().endsWith(id)) {
                e = estudiantesArray.get(i);    
                break;
            }
        }
        return e;
