...
## Resumen ##
Interfa que permite convertir grados Celsius a Fahrenheit y viceversa.

## Codigo ##

El código solución se puede encontrar en el archivo [TempConversion.java](TempConversion.java) cuyo contenido se muestra a continuación:
...
public class TempConversion extends JFrame {
    ...
    public TempConversion() {
        ...
        celsiusLabel = new JLabel("Temp en Celsius: ", SwingConstants.RIGHT);
        fahrenheitLabel = new JLabel("Temp en Fahrenheit: ", SwingConstants.RIGHT);
...
![programa_grados](TempConversion.jpg)
