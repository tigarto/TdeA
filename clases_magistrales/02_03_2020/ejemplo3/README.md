...
## Resumen ##
Agrega a la interfaz del [ejemplo 2](../ejemplo2) la logica necesaria para la interacción de la interfaz con el usuario.

## Codigo ##

El código solución se puede encontrar en el archivo [RectangleProgram.java](RectangleProgram.java) cuyo contenido se muestra a continuación:
...
![programa_rectangulo](RectanguleApp2.jpg)
